    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/files/multiImageUpload'; 	//upload URL
	...
	function onAjaxError (e){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/files/singleImageUpload',	//샘플 URL입니다.
 	        sCallback : '/common/smart/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
